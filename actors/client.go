...
func InvokeAsk[R any](ctx context.Context, ref Ref, payload any, opts ...AskOption) (R, error) {
	...
	if err := clientInvokerFactory(ref).InvokeAsk(ctx, ref, method, payload, &zero, cfg); err != nil {
		return zero, err
	}
	return zero, nil
}
...
func InvokeQuery[R any](ctx context.Context, ref Ref, payload any) (R, error) {
	...
	if err := clientInvokerFactory(ref).InvokeQuery(ctx, ref, method, payload, &zero); err != nil {
		return zero, err
	}
	return zero, nil
}
